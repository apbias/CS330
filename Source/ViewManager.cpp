 ...
 *  ProcessMouseScroll()
 *
 *  This method is called to process any mouse scrolling
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection)
	{
		...
		float orthoScale = 20.0f; // adjust as needed
		projection = glm::ortho(-orthoScale, orthoScale, -orthoScale, orthoScale, 0.1f, 100.0f);
		g_pCamera->Position = glm::vec3(0.0f, 8.0f, 20.0f); // update the camera position for orthographic view
